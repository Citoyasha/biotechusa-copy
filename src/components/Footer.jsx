...
function FacebookIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.99 22 12"/></svg>
  )
}

function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.336 3.608 1.311.975.975 1.249 2.242 1.311 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.336 2.633-1.311 3.608-.975.975-2.242 1.249-3.608 1.311-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.336-3.608-1.311-.975-.975-1.249-2.242-1.311-3.608C2.175 15.747 2.163 15.367 2.163 12s.012-3.584.07-4.85c.062-1.366.336-2.633 1.311-3.608C4.519 2.567 5.786 2.293 7.152 2.231 8.418 2.175 8.798 2.163 12 2.163m0 1.802c-3.142 0-3.514.012-4.755.069-1.022.047-1.578.218-1.948.362-.49.19-.84.418-1.207.785-.367.367-.595.717-.785 1.207-.144.37-.315.926-.362 1.948-.057 1.241-.069 1.613-.069 4.755s.012 3.514.069 4.755c.047 1.022.218 1.578.362 1.948.19.49.418.84.785 1.207.367.367.717.595 1.207.785.37.144.926.315 1.948.362 1.241.057 1.613.069 4.755.069s3.514-.012 4.755-.069c1.022-.047 1.578-.218 1.948-.362.49-.19.84-.418 1.207-.785.367-.367.595-.717.785-1.207.144-.37.315-.926.362-1.948.057-1.241.069-1.613.069-4.755s-.012-3.514-.069-4.755c-.047-1.022-.218-1.578-.362-1.948-.19-.49-.418-.84-.785-1.207-.367-.367-.717-.595-1.207-.785-.37-.144-.926-.315-1.948-.362-1.241-.057-1.613-.069-4.755-.069M12 6.865A5.135 5.135 0 1 0 12 17.135 5.135 5.135 0 0 0 12 6.865m0 8.468A3.333 3.333 0 1 1 12 8.667a3.333 3.333 0 0 1 0 6.666m6.538-8.671a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0"/></svg>
  )
}

function YoutubeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M21.582 7.186a2.506 2.506 0 0 0-1.768-1.768C18.254 5 12 5 12 5s-6.254 0-7.814.418A2.506 2.506 0 0 0 2.418 7.186C2 8.746 2 12 2 12s0 3.254.418 4.814a2.506 2.506 0 0 0 1.768 1.768C5.746 19 12 19 12 19s6.254 0 7.814-.418a2.506 2.506 0 0 0 1.768-1.768C22 15.254 22 12 22 12s0-3.254-.418-4.814M10 15V9l5.196 3z"/></svg>
  )
}

function TwitterIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M22.46 6c-.77.35-1.6.58-2.46.69.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05A4.28 4.28 0 0 0 12 9.71c0 .34.04.67.11.99C8.28 10.5 5.11 8.79 3 6.16c-.37.64-.58 1.38-.58 2.17 0 1.49.76 2.81 1.91 3.58-.71 0-1.37-.22-1.95-.54v.03c0 2.08 1.48 3.82 3.44 4.21-.36.1-.74.15-1.13.15-.27 0-.54-.03-.8-.08.54 1.69 2.11 2.95 4 2.98A8.6 8.6 0 0 1 2 19.54a12.1 12.1 0 0 0 6.56 1.92c7.88 0 12.21-6.54 12.21-12.21 0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.13-2.22z"/></svg>
  )
}
...
function LinkedInIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zM8.339 18.338v-7.16H5.962v7.16zM7.151 10.097c.764 0 1.382-.62 1.382-1.382a1.38 1.38 0 1 0-2.764 0c0 .763.618 1.382 1.382 1.382m11.187 8.241v-3.926c0-2.06-.446-3.644-2.852-3.644-1.156 0-1.932.634-2.249 1.235h-.032v-1.045h-2.281v7.38h2.374V14.69c0-.964.183-1.898 1.378-1.898 1.179 0 1.194 1.102 1.194 1.96v3.586z"/></svg>
  )
}
...
function Footer() {
  ...
  return (
    <footer className="w-full bg-[#2d3640] text-[#9aa5b1]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 lg:pt-20 pb-8">
        {/* Newsletter */}
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-white text-2xl sm:text-3xl lg:text-[34px] font-extrabold italic uppercase tracking-tight">
            The Feeling of Success
          </h2>
          <p className="mt-5 text-sm lg:text-base text-[#9aa5b1] leading-relaxed">
          ...
          <div className="mt-7 flex justify-center">
            <a
              href="#"
              className="inline-flex items-center justify-center px-12 sm:px-16 py-3.5 bg-[#1ea7e1] hover:bg-[#1893c8] text-white text-sm font-bold tracking-widest uppercase transition-colors w-full sm:w-auto sm:min-w-[280px]"
            >
              S'inscrire
            </a>
          </div>
        ...
        <div className="hidden lg:grid lg:grid-cols-4 gap-8 mt-20">
              ...
              <ul className="flex flex-col gap-3">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-sm text-[#9aa5b1] hover:text-white transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
          ...
          <div>
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center px-6 py-3 border border-[#9aa5b1] text-white text-xs font-bold tracking-wider uppercase hover:bg-white hover:text-[#2d3640] transition-colors"
            >
        ...
        <div className="lg:hidden mt-12 border-t border-[#3d4752]">
          {linkColumns.map((column) => {
            const isOpen = openSection === column.title
            return (
              <div key={column.title} className="border-b border-[#3d4752]">
                <button
                  onClick={() => toggle(column.title)}
                  className="w-full flex items-center justify-between py-4 text-white text-sm font-bold uppercase tracking-wider"
          ...
          {/* Magasins accordion */}
          <div className="border-b border-[#3d4752]">
            <button
        ...
        {/* Social icons */}
        <div className="mt-12 lg:mt-16 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
          {socialLinks.map(({ label, href, Icon }) => (
            <a
              key={label}
              href={href}
              aria-label={label}
              className="flex items-center justify-center w-10 h-10 rounded-full bg-[#d6dade] text-[#2d3640] hover:bg-white transition-colors"
            >
              <Icon />
            </a>
          ))}
        ...
        {/* Bottom bar */}
        <div className="mt-10 lg:mt-12 pt-6 border-t border-[#3d4752] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#9aa5b1]">
